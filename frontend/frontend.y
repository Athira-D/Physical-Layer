...
%token SELECT INTO FROM WHERE PROJECT INTTYPE FLOATTYPE STRINGTYPE CREATE DROP TABLE INDEX ALTER RENAME TO JOIN ID EXIT EQTK LTTK GTTK LETK GETK NETK  ON COLUMN AND INSERT VALUES
